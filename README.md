...
Here is an in-game screenshot of the menu:
 ...
 It's clear to see where my inspiration for the reimagining of the app came from. Feel free to view/use this app on my <a href='http://derlingb.info/projects/ds3-ar/app.html'>site</a>. (Style not optimized for mobile viewing)
